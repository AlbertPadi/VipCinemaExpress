            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9">
                            <asp:TextBox ID="PassWord1TextBox" TextMode="Password" class="form-control" runat="server" placeholder="Confirmar Password" OnTextChanged="PassWord1TextBox_TextChanged"></asp:TextBox>
                        </div>
                    </div>
                    <div class="form-group">
