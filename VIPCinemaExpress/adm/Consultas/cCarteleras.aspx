<%@ Page Title="" Language="C#" MasterPageFile="~/adm/Site.Master" AutoEventWireup="true" CodeBehind="cCarteleras.aspx.cs" Inherits="VIPCinemaExpress.adm.Consultas.cCarteleras" %>
        ...
        <div id="page-wrapper">
            <div class="panel-body">
                <div class="form-horizontal col-md-12" role="form">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">Vip Cinema Express<small>Consulta carteleras</small>
                            </h1>
                        </div>
